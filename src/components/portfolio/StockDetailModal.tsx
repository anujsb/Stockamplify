import ActionAnalysis from "@/components/portfolio/AdviceAnalysis";
...
import { Activity, ActivitySquare, AlarmClock, BarChart3, Brain, Calculator, Newspaper } from "lucide-react";
      ...
      <DialogContent className="max-w-[90vw] max-h-[90vh] overflow-y-auto sm:max-w-[90vw] sm:max-h-[90vh] md:max-w-[80vw] lg:max-w-[75vw] p-0">
        ...
        <Tabs defaultValue="overview" className="w-full px-0 md:px-2">
          ...
          <TabsList className="w-full">
            ...
            <TabsTrigger value="action-analysis" className="flex items-center gap-1">
              <AlarmClock className="h-3 w-3 sm:h-4 sm:w-4" />
              <span className="hidden sm:inline">Action Analysis</span>
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <TabsContent value="action-analysis" className="mt-0 h-full">
              <div className="p-4 sm:p-6">
                <ActionAnalysis item={stock} />
              </div>
            </TabsContent>
          </div>
        </Tabs>
